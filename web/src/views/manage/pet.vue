<template>
  <div>
    ...
    <el-table :data="tableData" border stripe style="width: 100%">
      ...
      <el-table-column prop="name" label="宠物名称" width="150"></el-table-column>
      <el-table-column label="宠物封面" width="200px">
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="30%"
      ...
      <el-form :model="entity">
        ...
        <el-form-item label="宠物描述" label-width="150px">
          <el-input type="textarea" v-model="entity.description" autocomplete="off" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="宠物分类" label-width="150px">
          <el-select v-model="entity.categoryId" placeholder="请选择宠物分类" style="width: 80%">
