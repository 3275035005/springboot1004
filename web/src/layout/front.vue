<template>
  <div>
    ...
    <div style="width: 100%; height: 60px; line-height: 60px; background-color: white">
      <el-row>
        <el-col :span="4">
          <div style="font-size: 20px; font-weight: bold; text-align: center"><a style="color: #409EFF;" href="/front/home">宠物用药指导系统</a></div>
        </el-col>
        <el-col :span="10">
        ...
        <el-col :span="6">
          <div v-if="!$route.path.includes('/search')">
            <el-input style="width: 80%" placeholder="请输入搜索宠物" v-model="searchText"></el-input>
